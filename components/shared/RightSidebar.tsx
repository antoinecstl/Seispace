      ...
      <div className='flex flex-col justify-center items-center'>
        {lastbet && (
          <>
            ...
            <p className="text-white mt-2">{lastbet.amount} $SEI by <span style={{ color: lastbet.color }}>{formatWalletAddress(lastbet.address)}</span></p>
          </>
        )}
        <h3 className='mt-4 text-heading4-medium max-xl:text-body-medium text-light-1'>Players</h3>
